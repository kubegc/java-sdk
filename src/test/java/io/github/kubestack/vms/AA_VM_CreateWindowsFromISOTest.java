 ...
 *
 */
public class AA_VM_CreateWindowsFromISOTest {
	...
	public static void main(String[] args) throws Exception {
		...
		boolean successful = client.virtualMachines()
				.createAndStartVMFromISO("win10", "vm.node22", createAndStartVMFromISO, "123");
...
//		createAndStartVMFromISO.setRedirdev("lusb,type=tcp,server=192.168.1.1:4000");
	...
	protected static String getOtherCDROMs() {
		return "--disk /var/lib/libvirt/iso/win10.iso,device=cdrom,perms=ro";
	}
