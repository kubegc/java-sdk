...
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.AutoStartVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.BackupVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.BatchDeprecatedACL;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.BindFloatingIP;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ChangeNumberOfCPU;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.CloneVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ConvertVMToImage;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.CreateAndStartVMFromISO;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.CreateAndStartVMFromImage;
...
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.EjectISO;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ExportVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.InjectSshKey;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.InsertISO;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ManageISO;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.MigrateVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.MigrateVMDisk;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ModifyACL;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ModifyQoS;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.PassthroughDevice;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.PlugDevice;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.PlugDisk;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.PlugNIC;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.RebootVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.RedirectUsb;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ResetVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ResizeMaxRAM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ResizeRAM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ResizeVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.ResumeVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.SetBootOrder;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.SetGuestPassword;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.SetQoS;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.SetVncPassword;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.StartVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.StopVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.StopVMForce;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.SuspendVM;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.TuneDiskQoS;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.TuneNICQoS;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.UnbindFloatingIP;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.UnplugDevice;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.UnplugDisk;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.UnplugNIC;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.UnsetQoS;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.UnsetVncPassword;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.UpdateGraphic;
import com.github.kubesys.kubernetes.api.specs.items.virtualmachine.Lifecycle.UpdateOS;
