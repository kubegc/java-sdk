...
public class VirtualMachinePoolImpl extends AbstractImpl<VirtualMachinePool, VirtualMachinePoolList, VirtualMachinePoolSpec> {
	 ...
	 * 
	 **************************************************/
	public boolean autoStart(String name, AutoStartPool autoStartPool) throws Exception {
		return autoStart(name, autoStartPool, null);
	}

	public boolean autoStart(String name, Lifecycle.AutoStartPool autoStartPool, String eventId) throws Exception {
