...
public class RegExpUtils {
	...
	public final static String PATH_PATTERN = "/var/lib/libvirt/[a-z0-9-/.]{18,1024}";
	...
	public static void main(String[] args) {
		String name = "vnc,listen=0.0.0.0,password=1234";
		Pattern pattern = Pattern.compile(RegExpUtils.GRAPHICS_PATTERN);
