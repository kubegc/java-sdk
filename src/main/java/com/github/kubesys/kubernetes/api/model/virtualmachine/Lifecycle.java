...
public class Lifecycle {
	...
	public static class CreateAndStartVMFromISO {
		...
		@Parameter(required = true, description = "虚拟机网络", constraint = 
				...
				+ "switch=ovn交换机名称（选填，只有type=l3bridge类型支持该参数）,参数顺序必须是type,source,ip,switch,inbound,outbound,mode,mac", example = "type=l3bridge,source=br-int,ip=192.168.5.9,switch=switch8888,inbound=102400,outbound=102400")
